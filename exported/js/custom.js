...
$(document).ready(function(){ 
	...
	*********************/		
	...
	$('.filter_portfolio a').click(function(e) {
	   ...
	   $clientsHolder.quicksand( $filters, {
			...
			easing: 'easeInOutQuint'
			 ...
			 $("a[data-pretty^='prettyPhoto']").prettyPhoto({animationSpeed:'fast',theme:'pp_default',slideshow:5000});
	...
	(hover effect)
	*********************/		
	$('#socialmedia ul li img, .blog_img img').each(function() {
                $(this).hover(
                    function() {
                        $(this).stop().animate({ opacity: 0.5 }, 'slow');
                    },
	...
	*********************/
	 $('#flickr').jflickrfeed({
			...
			itemTemplate: '<li>'+
							'<a data-pretty="prettyPhoto[gallery99]" href="{{image}}" title="{{title}}">' +
